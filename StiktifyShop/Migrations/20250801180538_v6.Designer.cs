...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StiktifyShop.Domain.Entity.OrderItem", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("StiktifyShop.Domain.Entity.Cart", b =>
                {
                    b.HasOne("StiktifyShop.Domain.Entity.ProductOption", "Option")
                        .WithMany("Carts")
                    ...
                    b.HasOne("StiktifyShop.Domain.Entity.ProductVariant", "Variant")
                        .WithMany("Carts")
            ...
            modelBuilder.Entity("StiktifyShop.Domain.Entity.Order", b =>
                {
                    ...
                    b.HasOne("StiktifyShop.Domain.Entity.Payment", null)
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("StiktifyShop.Domain.Entity.OrderItem", b =>
                {
                    ...
                    b.HasOne("StiktifyShop.Domain.Entity.ProductVariant", "ProductVariant")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("StiktifyShop.Domain.Entity.ProductRating", b =>
                {
                    ...
                    b.HasOne("StiktifyShop.Domain.Entity.Order", "Order")
                        .WithOne("Rating")
                        .HasForeignKey("StiktifyShop.Domain.Entity.ProductRating", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
